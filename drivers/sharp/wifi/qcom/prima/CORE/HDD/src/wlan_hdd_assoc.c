...
/* [WLAN][SHARP] 2013.10.31 Fix for connection problem around MAC filtered AP Start */
...
/* [WLAN][SHARP] 2013.10.31 Fix for connection problem around MAC filtered AP End */
        {
